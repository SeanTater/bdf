                ...
                [
                    (
                        ...
                        ::vulkano::shader::EntryPointInfo {
                            ...
                            descriptor_requirements: (0..param_count as u32).into_iter().map(|ix| ((0, ix), req.clone())).collect(),
                            push_constant_requirements: None,
                            specialization_constant_requirements: Default::default(),
                            input_interface: ::vulkano::shader::ShaderInterface::new_unchecked(
                                    vec![],
                                ),
                            output_interface: ::vulkano::shader::ShaderInterface::new_unchecked(
                                vec![],
                            ),
                        },
                    ),
